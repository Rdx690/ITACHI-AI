...
async function startGodszealBotInc() {
    ...
    GodszealBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || '𝐈𝐓𝐀𝐂𝐇𝐈-𝐀𝐈'} ]`)}\n\n`))
            ...
            console.log(chalk.green(`${global.themeemoji || '•'} 🤖 𝐈𝐓𝐀𝐂𝐇𝐈-𝐀𝐈 𝐁𝐨𝐭 Connected Successfully! ✅ 𝐀𝐍𝐘 𝐏𝐑𝐎𝐁𝐋𝐄𝐌 𝐓𝐎 𝐌𝐀𝐒𝐒𝐀𝐆𝐄 916909950582`))
        }
        if (
            connection === "close" &&
            lastDisconnect &&
